    ...
    if (isDatabaseProductExistID($product_select_id)) {
        ...
        <form action="/complement/product/<?php echo $product_select_id ?>" method="post">
            ...
            <div>
                ...
                <?php
                if (getDatabaseProductComplementRowCountByProductID($product_select_id) > 0) {
                    ?>
                ...
                if (getDatabaseProductAdditionalRowCountByProductID($product_select_id) > 0) {
                    ?>
                ...
                if (getDatabaseProductQuestionRowCountByProductID($product_select_id) > 0) {
                    ?>
